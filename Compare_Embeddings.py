...
def compare_embeddings(frame_list,label_df,model,path,speaker_label,anchor, margin=0.45):
    ...
    for i, frame in enumerate(frame_list):
        ...
        embedding = model(spectrogram)
        #if true_labels[i] == 1:
        #    print(torch.dist(anchor,embedding,p=2))
        frame_scores[i] = 1 if torch.dist(anchor,embedding,p=2) < 29 else 0
...
def main():
    ...
    parser.add_argument('--base-sample', default='/home/lucas/PycharmProjects/Papers_with_code/data/AMI/amicorpus_individual/Extracted_Speech/TS3005a_MTD018ID.wav', type=str,
                        help='path to base sample')
    parser.add_argument('--test-path', type=str, default='/home/lucas/PycharmProjects/Papers_with_code/data/AMI/pyannote/amicorpus/TS3005a/audio/TS3005a.Mix-Headset.wav'
    ...
    ground_truth = Prepare_Track(track_name='TS3005a.Mix-Headset',rttm_name='MixHeadset.train.rttm',path_to_track='/home/lucas/PycharmProjects/Papers_with_code/data/AMI/pyannote/amicorpus/TS3005a/audio', path_to_rttm='/home/lucas/PycharmProjects/Papers_with_code/data/AMI/pyannote/AMI')
    ...
    anchor = get_average_embedding(window_size=3, num_embeddings=10, path=args.base_sample, model=model)
