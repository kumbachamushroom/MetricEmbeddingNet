...
def batch_hard_triplet_loss(labels, embeddings, margin_negative, margin_positive, squared=False, device='cpu'):
    ...
    tl = hardest_positive_dist - hardest_negative_dist + margin_negative
